 ...
 * hxg 2019.9.26
 */
public class DoorApplyRenewalVisitorActivity extends BaseActivity implements View.OnClickListener, NewHttpResponse {
...
//    iv_id_card"tv_community"tv_identity"tv_to_real_name
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_door_apply_renewal_visitor);
        initView();
        initData();
    }
