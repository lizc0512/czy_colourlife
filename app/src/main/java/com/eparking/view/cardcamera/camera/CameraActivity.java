package com.eparking.view.cardcamera.camera;
...
import com.eparking.view.cardcamera.cropper.CropImageView;
import com.eparking.view.cardcamera.cropper.CropListener;
import com.eparking.view.cardcamera.global.Constant;
import com.eparking.view.cardcamera.utils.FileUtils;
import com.eparking.view.cardcamera.utils.ImageUtils;
import com.eparking.view.cardcamera.utils.PermissionUtils;
...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    public final static int TYPE_CARD_OTHER = 3;//其他证件
    ...
    private void init() {
        setContentView(R.layout.activity_eparking_camera);
    ...
    private void initView() {
        ...
        switch (mType) {
            ...
            case TYPE_IDCARD_BACK:
                ...
                break;
            case TYPE_CARD_OTHER:
                mIvCameraCrop.setImageResource(R.mipmap.camera_other_license);
                break;
        }
            ...
            public void onFinish(Bitmap bitmap) {
                ...
                if (FileUtils.createOrExistsDir(Constant.DIR_ROOT)) {
                    ...
                    if (mType == TYPE_IDCARD_FRONT) {
                        ...
                        imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append("otherCardCrop.jpg").toString();
                    }
