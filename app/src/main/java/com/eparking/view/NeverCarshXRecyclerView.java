...
import static com.external.maxwin.view.XListViewHeader.STATE_REFRESHING;
...
public class NeverCarshXRecyclerView extends RecyclerView {
    ...
    private NeverCarshXRecyclerView.LoadingListener mLoadingListener;
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0 && lastVisibleItemPosition >= layoutManager.getItemCount() - 1 && layoutManager.getItemCount() > layoutManager.getChildCount() && !isNoMore && mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING)
                if (layoutManager.getChildCount() > 0 && lastVisibleItemPosition >= mWrapAdapter.getItemCount() - 1 && !isNoMore && mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING) {
                    isLoadingData = true;
                    if (mFootView instanceof LoadingMoreFooter) {
    ...
    protected void onAttachedToWindow() {
        super.onAttachedToWindow(); //解决和CollapsingToolbarLayout冲突的问题
