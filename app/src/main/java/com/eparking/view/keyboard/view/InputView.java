package com.eparking.view.keyboard.view;
...
public class InputView extends LinearLayout {
    ...
    public InputView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        LinearLayout linearLayout = findViewById(R.id.input_root_view);
    ...
    public void setItemBorderTextColor(@ColorInt int textColor) {
        mFieldViewGroup.setupAllFieldsTextColor(textColor);
        invalidate();
    }
    ...
    public void performPosFieldView(int pos) {
        performFieldViewSetToSelected(mFieldViewGroup.getFieldAt(pos));
    }
