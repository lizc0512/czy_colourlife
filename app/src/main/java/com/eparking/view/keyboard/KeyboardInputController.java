package com.eparking.view.keyboard;
...
import com.eparking.view.keyboard.view.KeyboardView;
import com.eparking.view.keyboard.view.OnKeyboardChangedListener;
...
public class KeyboardInputController {
     ...
     */
    public KeyboardInputController(KeyboardView keyboardView, final InputView inputView) {
        ...
        mInputView.addOnFieldViewSelectedListener(new InputView.OnFieldViewSelectedListener() {
            ...
            public void onSelectedAt(int index) {
                ...
                Context context = mInputView.getContext();
                if (context instanceof Activity) {
                    KeyBoardUtils.hideSoftKeyboard((Activity) mInputView.getContext());
                }
...
//        mKeyboardView.addKeyboardChangedListener(new AutoCommit(mInputView));
    ...
    private OnKeyboardChangedListener syncKeyboardInputState() {
        return new OnKeyboardChangedListener.Simple() {
            ...
            public void onConfirmKey() {
                super.onConfirmKey();
                if (mInputView.getContext() instanceof Activity) {
                    PopupHelper.dismissFromActivity((Activity) mInputView.getContext());
                }
            }
        };
    }
