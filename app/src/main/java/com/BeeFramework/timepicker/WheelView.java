...
package com.BeeFramework.timepicker;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF40494F;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF40494F;
	...
	public int ADDITIONAL_ITEM_HEIGHT = 20;
...
//		setBackgroundResource(R.drawable.wheel_bg);
	...
	private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			scroller.fling(0, lastScrollY, 0, (int) -velocityY / 4, 0, 0, minY,
					maxY);
