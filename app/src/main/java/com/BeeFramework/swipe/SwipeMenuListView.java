...
//				mTouchView.smoothCloseMenu();
	...
	public void openAllMenu() {
		for (int position=getFirstVisiblePosition(); position<=getLastVisiblePosition(); position++) {
			View menuView = getChildAt(position - getFirstVisiblePosition());
			if (menuView instanceof SwipeMenuLayout) {
				mTouchPosition = position;
				SwipeMenuLayout touchView = (SwipeMenuLayout) menuView;
