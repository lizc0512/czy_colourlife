...
import static com.agentweb.ActionActivity.KEY_ACTION;
import static com.agentweb.ActionActivity.KEY_FROM_INTENTION;
import static com.agentweb.ActionActivity.KEY_URI;
import static com.agentweb.ActionActivity.start;
...
public class FileUpLoadChooserImpl implements IFileUploadChooser {
    ...
    private void openFileChooserInternal() {
        ...
        if (mAlertDialog == null)
            mAlertDialog = new AlertDialog.Builder(mActivity)
                    .setSingleChoiceItems(mFileUploadMsgConfig.getMedias(mActivity), -1, new DialogInterface.OnClickListener() {
                        @Override
    ...
    private void handleAboveL(final Uri[] datas) {
        if (mUriValueCallbacks == null)
            return;
