...
public class DefaultWebClient extends WrapperWebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
        ...
        //06-13 10:21:22.238 21630-21630/agentweb I/Info: url:weixin://wap/pay?appid%3Dwxb08de3dfbafe2a05%26noncestr%3Da3e707b7ba724555a623cdcb487c9752%26package%3DWAP%26prepayid%3Dwx20170613102122864958995b0782239150%26sign%3D54C503BE0D29F0013D71E9A5FB634E6D%26timestamp%3D1497320482

        if (webClientHelper && request.getUrl().toString().startsWith(WEBCHAT_PAY_SCHEME)) {
            startActivity(request.getUrl().toString());
            return true;
        }
        if (webClientHelper && hasAlipayLib )
            return true;
