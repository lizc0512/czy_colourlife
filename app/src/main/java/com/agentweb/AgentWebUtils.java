...
import static com.agentweb.AgentWebConfig.AGENTWEB_FILE_PATH;
import static com.agentweb.AgentWebConfig.FILE_CACHE_PATH;
...
//        /*如果无法直接打开，就跳出软件列表给用户选择 */
    ...
    static String getFileAbsolutePath(Activity context, Uri fileUri) {
        ...
        else if (fileUri.getAuthority().equalsIgnoreCase(context.getPackageName() + ".fileprovider")) {
