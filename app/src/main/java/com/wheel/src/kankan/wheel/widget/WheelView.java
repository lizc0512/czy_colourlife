...
package com.wheel.src.kankan.wheel.widget;
...
import com.wheel.src.kankan.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.ring_round_white_wheel;
