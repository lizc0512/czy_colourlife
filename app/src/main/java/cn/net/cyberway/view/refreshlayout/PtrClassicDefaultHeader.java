package cn.net.cyberway.view.refreshlayout;
...
import cn.net.cyberway.view.refreshlayout.indicator.PtrIndicator;
...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        webview_dns = (TextView) header.findViewById(R.id.webview_dns);
    ...
    public void setWebview_dns(String dns) {
        webview_dns.setVisibility(VISIBLE);
        webview_dns.setText(dns);
    }
