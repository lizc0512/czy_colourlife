...
public class HomeViewUtils {
    ...
    public  static  void showCommunityActivity(Activity activity,int  joinNumber,List<String> join_user_pics,ImageView iv_first_photo,ImageView iv_second_photo,ImageView iv_thrid_photo,TextView tv_join_person){
        if (joinNumber<=0){
