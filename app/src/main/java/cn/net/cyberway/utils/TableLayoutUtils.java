...
public class TableLayoutUtils {
    ...
    public static void showReportHealthyDialog(Activity activity, String img, String url) {
        ShowReportHealthyDialog showReportHealthyDialog = new ShowReportHealthyDialog(activity, R.style.opendoor_dialog_theme);
        showReportHealthyDialog.show();
        GlideImageLoader.loadImageDefaultDisplay(activity, img, showReportHealthyDialog.iv_report_healthy,R.drawable.home_report_healthy_bg,R.drawable.home_report_healthy_bg);
        showReportHealthyDialog.iv_report_healthy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LinkParseUtil.parse(activity, url, "");
                if (activity!=null){
